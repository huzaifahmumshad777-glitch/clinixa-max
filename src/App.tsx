...
export default function App() {
  ...
  const handleSavePatient = async (e: React.FormEvent) => {
    ...
    try {
      ...
      handleFirestoreError(err, isNew ? OperationType.CREATE : OperationType.UPDATE, 'patients');
  ...
  const handleBulkCompletePayments = async () => {
    ...
    try {
      ...
      handleFirestoreError(err, OperationType.WRITE, 'patients/bulk-complete');
  ...
  const handleBulkVoidRecords = async () => {
    ...
    try {
      ...
      handleFirestoreError(err, OperationType.WRITE, 'patients/bulk-void');
